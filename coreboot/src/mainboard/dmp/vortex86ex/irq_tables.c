...
//	0xa,			/* Checksum (has to be set to some value that
	0x00,			/* Checksum (has to be set to some value that //Let CB compute checksum
				 * would give 0 after the sum of all bytes
				 * for this structure (including checksum).
				 */
	{
		/* bus,        dev | fn,   {link, bitmap}, {link, bitmap}, {link, bitmap}, {link, bitmap}, slot, rfu */
		//x00, (0x01 << 3) | 0x0, {{0x01, 0xdef8}, {0x02, 0xdef8}, {0x03, 0xdef8}, {0x04, 0xdef8}}, 0x1, 0x0},
		/* 00:01.0 root PCIe bridge: INTA..INTD
		steer root bridge to IRQ 5 or IRQ7 */
		{0x00, (0x01 << 3) | 0x0, {{0x01, 0x00a0}, {0x02, 0x00a0}, {0x03, 0x00a0}, {0x04, 0x00a0}}, 0x1, 0x0},
		...
		/* 01:00.0 Pericom PCIe->PCI bridge: INTA..INTD
		Link: mirror upstream root bridge
		IRQs: allow IRQ {3,4,5,7,9,10,11} */
		{0x01, (0x00 << 3) | 0x0, {{0x01, 0x0ef8}, {0x02, 0x0ef8}, {0x03, 0x0ef8}, {0x04, 0x0ef8}}, 0x1, 0x0},
	}
};
